...
import { Heart, CreditCard, Wallet, Building2, User, Mail, MessageSquare } from "lucide-react"
import { z } from "zod"
...
export default function DonationForm({ 
  ...
  const handlePaymentSuccess = (transactionId: string) => {
    ...
    toast({
      title: projectType === 'give' ? "Thank you for your donation! ❤️" : "Thank you for backing this project! 🚀",
      description: (
        <div className="space-y-2">
          <p>Your support means a lot to {projectTitle}</p>
          <p className="text-sm text-muted-foreground">Transaction ID: {transactionId}</p>
          <p className="text-sm font-medium">Project is now {percentComplete}% funded!</p>
        </div>
      ),
    })
  ...
  const handleStripeSuccess = () => {
    ...
    handlePaymentSuccess(stripeClientSecret?.split('_secret')[0] || 'STRIPE-SUCCESS')
  }
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          {projectType === 'give' 
            ? (rewardId ? "Complete your donation" : "Make a donation to this cause")
            : (rewardId ? "Complete your pledge" : "Back this creative project")
          }
        </CardDescription>
      </CardHeader>
      <CardContent>
              ...
              <div>
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="eur" className="font-normal">EUR - Euro</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="VND" id="vnd" />
                    <Label htmlFor="vnd" className="font-normal">VND - Vietnamese Dong</Label>
                  </div>
                </RadioGroup>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-muted p-4 rounded-lg space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium capitalize">{form.watch("paymentMethod")}</span>
                </div>
                {form.watch("isAnonymous") && (
                  <div className="flex justify-between">
