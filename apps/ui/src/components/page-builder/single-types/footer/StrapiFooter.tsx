...
export async function StrapiFooter({ locale }: { locale: AppLocale }) {
  ...
  const { sections, logoImage, links, copyRight, socialLinks } =
    data.data || data

  console.log("StrapiFooter: Extracted data", {
    sections,
    logoImage,
    links,
    copyRight,
      ...
      <Container className="py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          {sections && sections.length > 0 && (
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-4 lg:grid-cols-4">
