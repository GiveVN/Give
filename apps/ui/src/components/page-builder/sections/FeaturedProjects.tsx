    ...
    <section className="py-24 sm:py-32">
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="text-3xl font-medium tracking-tight text-gray-950 sm:text-4xl mb-16">
            {title}
          </h2>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-100 p-8 lg:col-span-2">
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6 max-w-lg">
                  Track your project's performance with real-time analytics and insights that help you make data-driven decisions.
                </p>
              </div>
                ...
                <div className="rounded-xl bg-white/80 p-6 shadow-sm">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-semibold text-blue-600">$37,500</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-50 to-pink-100 p-8">
              ...
              <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white font-semibold text-sm ring-2 ring-white"
                  >
                    {String.fromCharCode(64 + i)}
                  </div>
                ))}
                <div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-semibold text-sm ring-2 ring-white">
                  +12
                </div>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-50 to-emerald-100 p-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm font-semibold text-gray-950">SSL Encrypted</div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-orange-50 to-red-100 p-8 lg:col-span-2">
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6 max-w-lg">
                  Manage your projects on the go with our intuitive mobile app. Available on iOS and Android.
                </p>
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-200 shadow-sm">
              <a href={buttonLink}>
                {buttonText}
              </a>
            </Button>
